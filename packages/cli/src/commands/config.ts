...
export const configCommand = new Command("config").description(
  "Manage and inspect OpenContrib capability configuration and security policies",
);

configCommand
  .command("init [workspacePath]")
  .description(
    "Generate an initial .opencontrib.json configuration file in the target workspace",
  )
...
configCommand
  ...
  .description(
    "Display the active effective OpenContrib capability configuration and policies",
  )
  .option("--pretty", "Pretty-print output", false)
  .action((workspacePath = ".", opts) => {
    try {
