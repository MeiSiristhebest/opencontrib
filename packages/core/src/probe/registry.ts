...
export const BUILTIN_PROBES: ProbeManifest[] = [
  // ── Dimension 1: AI-Native / Agentic Security & Review Frameworks ──
  {
    ...
    version: "1.0.0",
    description:
      "Alibaba OpenCodeReview hybrid rule matcher for NPE, thread safety, and concurrency traps",
  ...
  },
  {
    ...
    version: "1.0.0",
    description:
      "Vigolium Piolium 17-phase adversarial security audit and automated PoC constructor",
  ...
  },
  {
    ...
    version: "1.0.0",
    description:
      "GitHub Security Lab Taskflow multi-agent vulnerability and supply chain workflow",
    category: "security_cwe",
  ...
  },
  {
    ...
    version: "1.0.0",
    description:
      "Qodo PR-Agent automated regression test generator and code review assistant",
    category: "dead_code",
  ...
  // ── Dimension 2: High-Precision AST & Semantic Taint Analysis Engines ──
  {
    ...
    version: "1.0.0",
    description:
      "Lightweight semantic SAST for SQLi, path traversal, ReDoS, crypto flaws and OWASP Top 10",
    category: "security_cwe",
    ...
    execution: {
      ...
      stage: "scout",
      command:
        "semgrep scan --config auto --config p/security-audit --config p/owasp-top-ten --json --quiet {target}",
      timeoutMs: 30000,
      transformer: "semgrep",
    },
  },
  {
    ...
    version: "1.0.0",
    description:
      "Ultra-fast Tree-sitter AST structural search for dangerous patterns and API misuse",
  ...
  },
  {
    ...
    version: "1.0.0",
    description:
      "GitHub CodeQL inter-procedural relational database queries for multi-hop 0-day exploits",
    category: "security_cwe",
  ...
  // Go Probes
  {
    ...
    version: "1.0.0",
    description:
      "Uber Go static analyzer for cross-procedural nil pointer dereference panics",
    category: "lifecycle_leak",
  ...
  },
  {
    ...
    version: "1.0.0",
    description:
      "Uber Go goroutine leak detector and unclosed watcher identifier",
    category: "lifecycle_leak",
    author: "Uber / OpenContrib",
    activation: {
      languages: ["go"],
  ...
  },
  {
    ...
    version: "1.0.0",
    description:
      "Go missing context.Context propagation detector in HTTP and RPC requests",
    category: "lifecycle_leak",
  ...
  },
  {
    ...
    version: "1.0.0",
    description:
      "Rust official Undefined Behavior (UB) and memory alignment interpreter",
    category: "memory_abi",
  ...
  },
  {
    ...
    version: "1.0.0",
    description:
      "Rust dependency crate security advisory and license compliance checker",
    category: "security_cwe",
  ...
  // Python Probes
  {
    ...
    version: "1.0.0",
    description:
      "Python AST bugbear, async traps, and mutable default parameter scanner",
    category: "protocol_drift",
  ...
  },
  {
    ...
    version: "1.0.0",
    description:
      "Microsoft Pyright strict type contract verification and interface drift auditor",
    category: "protocol_drift",
  ...
  // TypeScript / JavaScript Probes
  {
    ...
    version: "1.0.0",
    description:
      "TypeScript/JavaScript dead code, unused exports, and type leak scanner",
    category: "dead_code",
  ...
  },
  {
    ...
    version: "1.0.0",
    description:
      "Node.js security ruleset for child process injection, path traversal, and ReDoS",
    category: "security_cwe",
  ...
  // ── Dimension 4: Property-Based & Differential Fuzzing ──
  {
    ...
    version: "1.0.0",
    description:
      "Built-in property-based fuzz generator for extreme floats (NaN/Inf), CRLF, and boundary attacks",
  ...
  // ── Dimension 5: Git Hotspot & Churn Forensics (Code as a Crime Scene) ──
  {
    ...
    version: "1.0.0",
    description:
      "Code as a Crime Scene Git churn and cyclomatic complexity hotspot analyzer",
    category: "lifecycle_leak",
    author: "OpenContrib",
    activation: {
      languages: ["*"],
  ...
  // ── Dimension 6: Supply Chain & Workflow Modernization ──
  {
    ...
    version: "1.0.0",
    description:
      "Google OSV open-source vulnerability and CVE advisory auditor for package manifests",
    category: "security_cwe",
...
export class ProbeRegistry {
  ...
  private validateManifest(manifest: ProbeManifest): void {
    ...
    if (
      /^\.\/|^\/|\\\\|[^\w.\/-]/.test(manifest.name) ||
      manifest.name.includes("..")
    ) {
      throw new Error(
        `Probe manifest "${manifest.name}" contains invalid characters`,
      );
    }
    if (!manifest.activation || !Array.isArray(manifest.activation.languages)) {
      throw new Error(
        `Probe manifest "${manifest.name}" requires activation.languages array`,
      );
    }
    if (!manifest.execution || !manifest.execution.cost) {
      throw new Error(
        `Probe manifest "${manifest.name}" requires execution.cost`,
      );
    }
  }
}
