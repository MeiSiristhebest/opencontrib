...
export class DevelopmentUnsafeExecutionPort implements TrustedExecutionPort {
  ...
  async verifyGreen(
    ...
    return {
      ...
      roundsCompleted: green.stressResult.roundsCompleted,
      workersPerRound: green.stressResult.workersPerRound,
      executionsExpected: green.stressResult.executionsExpected,
