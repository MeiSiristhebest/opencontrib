 ...
 *
 * Relocated into the dependency-free `domain/` layer (Task 8). This module performs
 * pure string/regex matching and must never import the filesystem or subprocess
 * modules, nor touch the process environment — the architecture guard enforces this.
 */
